...
tr = {
    ...
    "Выходные": "Weekends",
    "Будние": "Weekdays",
    "Каждый конкретный день в неделе": "Custom days in week",
